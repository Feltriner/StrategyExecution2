...
columns_to_remove = ['UserName', 'Name', 'Email']
for col in columns_to_remove:
    if col in merged_df.columns:
        merged_df.drop(col, axis=1, inplace=True)

# Ensure 'File Name' is the last column
...
merged_df.to_csv(os.path.join(output_directory, 'ANONYM_merged_data.csv'), index=False)
